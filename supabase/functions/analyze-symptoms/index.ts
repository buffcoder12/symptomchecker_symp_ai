...
const diseaseSymptomWeights: Record<string, Record<string, number>> = {
  ...
  "Hypoglycemia": { "vomiting": 1, "fatigue": 1, "anxiety": 1, "sweating": 1, "headache": 1, "nausea": 1, "blurred_and_distorted_vision": 1, "fast_heart_rate": 1, "palpitations": 1, "drying_and_tingling_lips": 1, "slurred_speech": 1, "irritability": 1, "palpitations": 1 },
...
const descriptions: Record<string, string> = {
  ...
  "Malaria": "An infectious disease caused by protozoan parasites that can be transmitted by the bite of mosquitoes.",
